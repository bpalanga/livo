          ...
          {profile && (
            <>
              ...
              <div className="flex items-center ml-3">
                ...
                <button
                  onClick={onLogout}
                  className="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2 lg:px-5 lg:py-2.5 mr-2 focus:outline-none flex items-center"
                >
